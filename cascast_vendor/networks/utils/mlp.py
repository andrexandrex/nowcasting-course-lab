...
# ColumnParallelLinear / RowParallelLinear replaced with nn.Linear stubs for
# single-GPU / CPU inference (Mlp_parallel is not used by casformer at runtime).
from torch.nn import Linear as ColumnParallelLinear, Linear as RowParallelLinear
